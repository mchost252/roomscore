...
# Locate the Animated.ScrollView
start_str = "      {/* ── Scrollable content (starts below absolute header) ── */}\n      <Animated.ScrollView"
end_str = "      </Animated.ScrollView>"
...
new_block = """      {/* ── Scrollable content (starts below absolute header) ── */}
      <AnimatedFlatList
        onScroll={onScroll}
